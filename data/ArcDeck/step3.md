...
<div class="two-col">
  ...
  <div class="col">
    <p><span class="bold blue-text">ArcDeck (本研究)
...
![w:640](./step3-assets/figure-01.png)

Figure 1: section-level organization, or direct outline extraction, yielding condensed text without narrative Framework Comparison. (a) Prior methods rely on raw-text summarization, isolated
  </div>
</div>
...
Figure 2: ArcDeck Overview. 1) Preprocessing extracts textual and visual assets from the source
...
Figure 4: rative progression of the presentation through five key components: a snapshot, core content, a talk Global Commitment Example. The global commitment establishes the high-level nar-
  </div>
  <div class="col">
...
![w:640](./step3-assets/figure-06.png)

Figure 7: Qualitative Comparison. Unlike baselines, ArcDeck shows clear narrative flow instead
